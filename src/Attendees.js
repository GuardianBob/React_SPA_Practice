...
class Attendees extends Component {
    ...
    render() {
        ...
        // Filter array with Javascript: //fltr1
        // Below converts to lower case to avoid any case conflicts
            ...
            <div className="container mt-4">
                <div className="row justify-content-center">
                    <div className="col-md-8">
                        ...
                        <div className="card bg-light mb-4">
                            <div className="card-body text-center">
                                <div className="input-group input-group-lg">    {/* //fltr1 */}
                                    <input 
                                        type="text" 
                                        name="searchQuery" 
                    ...
                    <AttendeesList 
                        ...
                        attendees={filteredAttendees} />  {/* //fltr1 */}
                </div>
        );
    }
}
